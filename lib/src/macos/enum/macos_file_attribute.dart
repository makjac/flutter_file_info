/// Enumeration representing file attributes specific to the MacOS operating system.
///
/// This enum provides a set of constants that describe various permissions associated with files and directories on MacOS.
enum MacosFileAttribute {
  /// Resource is a read-only volume.
  readOnly,

  /// Resource is a directory and is the root of a volume.
  executable,

  /// Indicates whether the resource is an application.
  application,

  /// Indicates whether the application is scriptable.
  scriptable,
